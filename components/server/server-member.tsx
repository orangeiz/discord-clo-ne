...
const roleIconMap={[MemberRole.GUEST]:null,
...
export const ServerMember=({member,server}:ServerMemberProps)=>{
    ...
    className={cn("group px-2 py-2 rouned-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1",
